...
export default function Home() {
  ...
  const [convConfig, setConvConfig] = useState<ConversionConfig | null>(null);
    ...
    <main className="flex flex-col items-center gap-8 px-4 py-10 max-w-2xl mx-auto w-full">
      ...
      {imageBase64 && (
        <section className="w-full">
          ...
          <ConversionSettings
            onChange={setConvConfig}
            onReconvert={() => {
              if (convConfig) reconvert(imageBase64, convConfig);
            }}
            isLoading={isLoading}
          />
        </section>
